...
impl Table {
    ...
    fn to_text<'a>(&'a self, width: usize, style: Style, tunables: &'a TunableValues) -> Text<'a> {
        ...
        if let Some(caption) = &self.caption {
            ...
            let mut printer =
                TextPrinter::new(subw, style, true, tunables).align(Alignment::Center);
...
impl StyleTreeNode {
    pub fn to_text<'a>(
        ...
        let mut printer = TextPrinter::new(width, style, true, tunables);
    ...
    pub fn print<'a>(&'a self, printer: &mut TextPrinter<'a>, style: Style) {
        ...
        match self {
            ...
            StyleTreeNode::Table(table) => {
                let text = table.to_text(width, style, printer.tunables);
...
impl StyleTree {
    ...
    pub fn to_text<'a>(
        ...
        let mut printer = TextPrinter::new(width, style, hide_reply, tunables);
...
pub mod tests {
    ...
    fn test_header() {
        ...
        let text = tree.to_text(20, Style::default(), false, &tunables);
    ...
    fn test_paragraph() {
        ...
        let tree = parse_matrix_html(s);
        let text = tree.to_text(10, Style::default(), false, &tunables);
    ...
    fn test_list_unordered() {
        ...
        let tree = parse_matrix_html(s);
        let text = tree.to_text(8, Style::default(), false, &tunables);
    ...
    fn test_list_ordered() {
        ...
        let tree = parse_matrix_html(s);
        let text = tree.to_text(9, Style::default(), false, &tunables);
        assert_eq!(text.lines.len(), 6);
        assert_eq!(
            text.lines[0],
            Line::from(vec![
    ...
    fn test_table() {
        ...
        let tree = parse_matrix_html(s);
        let text = tree.to_text(15, Style::default(), false, &tunables);
        let bold = Style::default().add_modifier(StyleModifier::BOLD);
    ...
    fn test_matrix_reply() {
        ...
        let tree = parse_matrix_html(s);
        let text = tree.to_text(10, Style::default(), true, &tunables);
        assert_eq!(text.lines.len(), 2);
        assert_eq!(
            text.lines[0],
            Line::from(vec![
    ...
    fn test_self_closing() {
        ...
        let tree = parse_matrix_html(s);
        let text = tree.to_text(7, Style::default(), true, &tunables);
    ...
    fn test_embedded_newline() {
        ...
        let s = "<p>Hello\nWorld</p>";
        let tree = parse_matrix_html(s);
        let text = tree.to_text(15, Style::default(), true, &tunables);
    ...
    fn test_pre_tag() {
        ...
        let tree = parse_matrix_html(s);
        let text = tree.to_text(25, Style::default(), true, &tunables);
